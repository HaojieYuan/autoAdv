CUDA_VISIBLE_DEVICES=8 python train_model.py \
    ...
    --max_number_of_steps 2000  1> ./log/oxfordFlowers.log 2>&1
...
CUDA_VISIBLE_DEVICES=8 python train_model.py \
    ...
    --max_number_of_steps 2000  1> ./log/fgvcAircraft.log 2>&1
...
CUDA_VISIBLE_DEVICES=8 python train_model.py \
    ...
    --max_number_of_steps 2000  1> ./log/stanfordCars.log 2>&1