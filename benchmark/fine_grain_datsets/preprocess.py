...
def preprocess_for_train(image, in_height, in_width, bbox,
                         fast_mode=True,
                         scope=None,
  ...
  """
  with tf.name_scope(scope, 'distort_image', [image, in_height, in_width, bbox]):
    if bbox is None:
    ...
    distorted_image = apply_with_random_selector(
        distorted_image,
        lambda x, method: tf.image.resize_images(x, [in_height, in_width], method),
...
def preprocess_for_eval(image, in_height, in_width,
